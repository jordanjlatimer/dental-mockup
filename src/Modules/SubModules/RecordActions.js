...
export default function RecordActions(props){
  return(
    <div className="recordActions">
      {props.icons ? (props.icons.treatment ? <IoIosClipboard className="treatmentIcon" size="28px"/> : null) : null}
      {props.icons ? (props.icons.order ? <IoIosCart className="cartIcon" size="28px"/> : null) : null}
